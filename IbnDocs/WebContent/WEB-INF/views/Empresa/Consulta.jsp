...
<c:set var="bodyContent">
	...
	<div class="page-bar">
		<ul class="page-breadcrumb">
			...
			<li><span>Empresas</span><i class="fa fa-circle"></i></li>
...
<div class="btn-group">
						<a href="/IbnDocs/Empresa/Cadastro"
						...
						<tbody>
							...
							<%
								EntityManager em = new ConexaoEntityFactory().getEntityManager();
									Query query = (Query) em.createNativeQuery("SELECT emp_id, emp_empresa, emp_cnpj FROM sistema.empresa");
								...
								<td class="hidden-xs">
									<div class="btn-group pull-right">
										...
										<ul class="dropdown-menu pull-right">
											<li><a
												href="/IbnDocs/Empresa/Editar?id=<%out.print(obj[0]);%>">
													<i class="fa fa-edit"></i> Alterar
											</a></li>
											<li><a
												href="/IbnDocs/Empresa/Excluir?id=<%out.print(obj[0]);%>">
