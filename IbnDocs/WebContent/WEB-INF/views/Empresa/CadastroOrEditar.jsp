...
<c:set var="bodyContent">
	...
	<div class="page-bar">
		<ul class="page-breadcrumb">
			...
			<li><span> Empresa</span> <i class="fa fa-circle"></i></li>
			<li><a href="/IbnDocs/Empresa/Consulta">Consulta</a>
				<i class="fa fa-circle"></i></li>
	...
	<!-- BEGIN PAGE TITLE-->
	<h1 class="page-title">
		Cadastro de Empresas <small>Campos Obrigatórios (*)</small>
	</h1>
	<!-- END PAGE TITLE-->
	<!-- END PAGE HEADER-->
					...
					<div class="col-md-12">
						...
						<div class="portlet light portlet-fit portlet-form bordered">
							...
							<div class="portlet-body">
								<!-- BEGIN FORM-->
								<form action="/IbnDocs/Empresa/Salvar"
									id="form_sample_2" method="POST" class="form-horizontal">

									<input style="display: none" name="empId" id="empId"
										value="${empresa.empId}">
									...
									<div class="form-body">
											...
											<div class="col-md-4">
												<div class="input-icon right">
													<i class="fa"></i> <input type="text" class="form-control"
														name="empEmpresa" id="empEmpresa"  value="${empresa.empEmpresa}" />
												</div>
											</div>
										</div>
										<div class="form-group  margin-top-20">
											...
											<div class="col-md-4">
												<div class="input-icon right">
													<i class="fa"></i> <input type="text" class="form-control"
														name="empCnpj" id="empCnpj"  value="${empresa.empCnpj}" />
												</div>
											</div>
										</div>
										...
										<div class="form-group  margin-top-20">
											...
											<div class="col-md-4">
												<div class="input-icon right">
													<i class="fa"></i> <input type="text" class="form-control"
														name="empEndereco" id="empEndereco"  value="${empresa.empEndereco}" />
												</div>
											</div>
										</div>
									</div>
