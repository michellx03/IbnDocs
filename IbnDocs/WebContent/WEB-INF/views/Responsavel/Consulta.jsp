...
<div class="btn-group">
						<a href="/IbnDocs/Responsavel/Cadastro"
						...
						<tbody>
							...
							<%
								EntityManager em = new ConexaoEntityFactory().getEntityManager();
									Query query = (Query) em.createNativeQuery("SELECT res_id, res_responsavel FROM sistema.responsavel");
								...
								<td class="hidden-xs">
									<div class="btn-group pull-right">
										...
										<ul class="dropdown-menu pull-right">
											<li><a
												href="/IbnDocs/Responsavel/Editar?id=<%out.print(obj[0]);%>">
													<i class="fa fa-edit"></i> Alterar
											</a></li>
											<li><a
												href="/IbnDocs/Responsavel/Excluir?id=<%out.print(obj[0]);%>">
