...
<div class="btn-group">
						<a href="/IbnDocs/Documentos/Cadastro"
						...
						<tbody>
							...
							<%
								EntityManager em = new ConexaoEntityFactory().getEntityManager();
									Query query = (Query) em.createNativeQuery("SELECT doc_id, doc_descricao, doc_data_entrega, res_responsavel FROM sistema.documentos INNER JOIN sistema.responsavel ON doc_remetente = res_id");
							...
							<%
								EntityManager emDest = new ConexaoEntityFactory().getEntityManager();
									Query queryDest = (Query) emDest.createNativeQuery("SELECT doc_id, doc_descricao, doc_data_entrega, res_responsavel FROM sistema.documentos INNER JOIN sistema.responsavel ON doc_destinatario = res_id");
									List<Object[]> listDest = queryDest.getResultList();
									for (Object[] objDest : listDest) {
							%>
								...
								<td class="hidden-xs">
									<div class="btn-group pull-right">
										...
										<ul class="dropdown-menu pull-right">
											<li><a
												href="/IbnDocs/Documentos/Editar?id=<%out.print(obj[0]);%>">
													<i class="fa fa-edit"></i> Alterar
											</a></li>
											<li><a
												href="/IbnDocs/Documentos/Excluir?id=<%out.print(obj[0]);%>">
